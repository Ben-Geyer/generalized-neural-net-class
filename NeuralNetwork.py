...
class NeuralNetwork(object):
    ...
    def train(self, x, y, step_size = 0.01, epochs = 1000, seed = 1, method = 'gradient_descent', batch_size = None, batch_ratio = 1, momentum = 0.9, discount = 0.9, b1 = 0.9, b2 = 0.999, smoothing = np.exp(-8)):
